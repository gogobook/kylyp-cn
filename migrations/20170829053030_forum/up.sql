CREATE TABLE users (
 ...
 INSERT INTO users (id, email, username, password, regtime) VALUES
...
CREATE TABLE  comment (
 ...
 INSERT INTO comment (id, aid, uid, content, createtime) VALUES
 ...
 (3, 1, 2, 'Rust通过`impl关键字在struct、enum`或者trait对象上实现方法调用语法', '2017-07-23 23:41:45.672805609 +08:00'),
 ...
 (6, 1, 2, 'Rust提供了两个特性来处理并发 (concurrency)：Send和Sync', '2017-07-23 23:41:45.672805609 +08:00'),
